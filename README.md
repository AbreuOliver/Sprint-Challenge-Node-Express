...
> I learned that Express is a framework for Node.js

- [ ] Describe Middleware?
> Any function that is executed before the 'core funtion` of the program is returned. 

- [ ] Describe a Resource?
> Everything!

- [ ] What can the API return to help clients know if a request was successful?
> A status code (in the 200s, most likely)! 
